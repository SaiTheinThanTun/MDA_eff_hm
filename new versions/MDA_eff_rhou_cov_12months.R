...
result <- readRDS("results_rhou_cov/results_2018-02-13 170323.rds")
...
png(paste('results_rhou_cov/rhou_MDAcoverage_12hr_',gsub("\\:","",Sys.time()),'.png',sep=''),height= 1600, width=1800, units= "px", res=300)
