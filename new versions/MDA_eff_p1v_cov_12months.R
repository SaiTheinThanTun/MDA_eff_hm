...
result <- readRDS("results_p1v_cov/results_2018-02-14 100337.rds")
...
png(paste('results_p1v_cov/p1v_MDAcoverage_12hr_',gsub("\\:","",Sys.time()),'.png',sep=''),height= 1600, width=1800, units= "px", res=300)
