...
List modGMSrcpp(double t, NumericVector state, NumericVector parameters) 
{
  ...
  double lamH = ((homogen/2)*(beta0_new+beta1_new)*((IC_0+Tr_0+rhoa*IA_0+rhou*IU_0)+(IC_1+Tr_1+rhoa*IA_1+rhou*IU_1)))/(P0+P1);
  
  double lam0 = ((1-homogen)*beta0_new*(IC_0+Tr_0+rhoa*IA_0+rhou*IU_0)/P0)+lamH;
  double lam1 = ((1-homogen)*beta1_new*(IC_1+Tr_1+rhoa*IA_1+rhou*IU_1)/P1)+lamH;
  ...
  // Additional file: Equation no.16 // because of lamH formulation, this vaccination is no longer consistent!
